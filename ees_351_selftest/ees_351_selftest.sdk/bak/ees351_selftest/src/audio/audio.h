#ifndef __AUDIO_H_
#define __AUDIO_H_
int test_audio(XUartPs *InstancePtr);
#include "xparameters.h"

//Base addresses
#define AUDIO_BASE				XPAR_ZED_AUDIO_CTRL_0_BASEADDR	//see xparameters.h

//Slave address for the ADAU audio controller
#define IIC_SLAVE_ADDR			0x76			//see ADAU1761 datasheet
...
//Audio controller registers			//see the user_logic file in its definition
enum i2s_regs {

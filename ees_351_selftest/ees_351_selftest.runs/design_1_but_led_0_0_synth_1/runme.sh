...
HD_PWD='E:/EES_351/ees_351_selftest/ees_351_selftest.runs/design_1_but_led_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_but_led_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_but_led_0_0.tcl

...
--               e:/EES_Board/EES_335/EES_335.srcs/sources_1/bd/EES_335/ip/EES_335_OV_Sensor_ML_0_0/EES_335_OV_Sensor_ML_0_0_sim_netlist.vhdl
...
entity EES_335_OV_Sensor_ML_0_0_cmos_decode is
  port (
  ...
  attribute ORIG_REF_NAME of EES_335_OV_Sensor_ML_0_0_cmos_decode : entity is "cmos_decode";
end EES_335_OV_Sensor_ML_0_0_cmos_decode;

architecture STRUCTURE of EES_335_OV_Sensor_ML_0_0_cmos_decode is
  ...
  signal \rgb565_o[4]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cmos_data_d0[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \cmos_data_d0[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cmos_data_d0[2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cmos_data_d0[3]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \cmos_data_d0[4]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \cmos_data_d0[5]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \rgb565_o[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rgb565_o[10]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rgb565_o[11]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rgb565_o[12]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rgb565_o[13]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rgb565_o[14]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rgb565_o[15]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \rgb565_o[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rgb565_o[4]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rgb565_o[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rgb565_o[6]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rgb565_o[7]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rgb565_o[8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rgb565_o[9]_i_1\ : label is "soft_lutpair11";
...
\rgb565_o[4]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity EES_335_OV_Sensor_ML_0_0_count_reset_v1 is
  port (
    \rst_n_reg_reg[4]\ : out STD_LOGIC;
    CLK_i : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of EES_335_OV_Sensor_ML_0_0_count_reset_v1 : entity is "count_reset_v1";
end EES_335_OV_Sensor_ML_0_0_count_reset_v1;

architecture STRUCTURE of EES_335_OV_Sensor_ML_0_0_count_reset_v1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity EES_335_OV_Sensor_ML_0_0_OV_Sensor_ML is
  port (
    rgb_o : out STD_LOGIC_VECTOR ( 15 downto 0 );
    hs_o : out STD_LOGIC;
    vs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of EES_335_OV_Sensor_ML_0_0_OV_Sensor_ML : entity is "OV_Sensor_ML";
end EES_335_OV_Sensor_ML_0_0_OV_Sensor_ML;

architecture STRUCTURE of EES_335_OV_Sensor_ML_0_0_OV_Sensor_ML is
  signal cmos_data_r : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal cmos_href_r : STD_LOGIC;
  signal cmos_vsync_r : STD_LOGIC;
  signal nolabel_line80_n_0 : STD_LOGIC;
begin
...
cmos_decode_u0: entity work.EES_335_OV_Sensor_ML_0_0_cmos_decode
     port map (
      CLK_i => CLK_i,
      D(0) => cmos_vsync_r,
...
nolabel_line80: entity work.EES_335_OV_Sensor_ML_0_0_count_reset_v1
     port map (
      CLK_i => CLK_i,
      \rst_n_reg_reg[4]\ => nolabel_line80_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity EES_335_OV_Sensor_ML_0_0 is
  ...
  attribute NotValidForBitStream of EES_335_OV_Sensor_ML_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of EES_335_OV_Sensor_ML_0_0 : entity is "EES_335_OV_Sensor_ML_0_0,OV_Sensor_ML,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of EES_335_OV_Sensor_ML_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of EES_335_OV_Sensor_ML_0_0 : entity is "OV_Sensor_ML,Vivado 2017.4";
end EES_335_OV_Sensor_ML_0_0;

architecture STRUCTURE of EES_335_OV_Sensor_ML_0_0 is
...
inst: entity work.EES_335_OV_Sensor_ML_0_0_OV_Sensor_ML
     port map (
      CLK_i => \^clk_i\,

...
(* CORE_GENERATION_INFO="hls_sobel,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=669,HLS_SYN_LUT=1840}" *)
...
wire    Block_Mat_exit7_proc_U0_ap_start;
wire    Block_Mat_exit7_proc_U0_start_full_n;
wire    Block_Mat_exit7_proc_U0_ap_done;
wire    Block_Mat_exit7_proc_U0_ap_continue;
wire    Block_Mat_exit7_proc_U0_ap_idle;
wire    Block_Mat_exit7_proc_U0_ap_ready;
wire    Block_Mat_exit7_proc_U0_start_out;
wire    Block_Mat_exit7_proc_U0_start_write;
wire   [31:0] Block_Mat_exit7_proc_U0_img_0_rows_V_out_din;
wire    Block_Mat_exit7_proc_U0_img_0_rows_V_out_write;
wire   [31:0] Block_Mat_exit7_proc_U0_img_0_cols_V_out_din;
wire    Block_Mat_exit7_proc_U0_img_0_cols_V_out_write;
wire   [31:0] Block_Mat_exit7_proc_U0_img_1_rows_V_out_din;
wire    Block_Mat_exit7_proc_U0_img_1_rows_V_out_write;
wire   [31:0] Block_Mat_exit7_proc_U0_img_1_cols_V_out_din;
wire    Block_Mat_exit7_proc_U0_img_1_cols_V_out_write;
wire   [31:0] Block_Mat_exit7_proc_U0_img_2_rows_V_out_din;
wire    Block_Mat_exit7_proc_U0_img_2_rows_V_out_write;
wire   [31:0] Block_Mat_exit7_proc_U0_img_2_cols_V_out_din;
wire    Block_Mat_exit7_proc_U0_img_2_cols_V_out_write;
...
Block_Mat_exit7_proc Block_Mat_exit7_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(Block_Mat_exit7_proc_U0_ap_start),
    .start_full_n(Block_Mat_exit7_proc_U0_start_full_n),
    .ap_done(Block_Mat_exit7_proc_U0_ap_done),
    .ap_continue(Block_Mat_exit7_proc_U0_ap_continue),
    .ap_idle(Block_Mat_exit7_proc_U0_ap_idle),
    .ap_ready(Block_Mat_exit7_proc_U0_ap_ready),
    .start_out(Block_Mat_exit7_proc_U0_start_out),
    .start_write(Block_Mat_exit7_proc_U0_start_write),
    .rows(rows),
    .cols(cols),
    .img_0_rows_V_out_din(Block_Mat_exit7_proc_U0_img_0_rows_V_out_din),
    .img_0_rows_V_out_full_n(img_0_rows_V_c_full_n),
    .img_0_rows_V_out_write(Block_Mat_exit7_proc_U0_img_0_rows_V_out_write),
    .img_0_cols_V_out_din(Block_Mat_exit7_proc_U0_img_0_cols_V_out_din),
    .img_0_cols_V_out_full_n(img_0_cols_V_c_full_n),
    .img_0_cols_V_out_write(Block_Mat_exit7_proc_U0_img_0_cols_V_out_write),
    .img_1_rows_V_out_din(Block_Mat_exit7_proc_U0_img_1_rows_V_out_din),
    .img_1_rows_V_out_full_n(img_1_rows_V_c_full_n),
    .img_1_rows_V_out_write(Block_Mat_exit7_proc_U0_img_1_rows_V_out_write),
    .img_1_cols_V_out_din(Block_Mat_exit7_proc_U0_img_1_cols_V_out_din),
    .img_1_cols_V_out_full_n(img_1_cols_V_c_full_n),
    .img_1_cols_V_out_write(Block_Mat_exit7_proc_U0_img_1_cols_V_out_write),
    .img_2_rows_V_out_din(Block_Mat_exit7_proc_U0_img_2_rows_V_out_din),
    .img_2_rows_V_out_full_n(img_2_rows_V_c_full_n),
    .img_2_rows_V_out_write(Block_Mat_exit7_proc_U0_img_2_rows_V_out_write),
    .img_2_cols_V_out_din(Block_Mat_exit7_proc_U0_img_2_cols_V_out_din),
    .img_2_cols_V_out_full_n(img_2_cols_V_c_full_n),
    .img_2_cols_V_out_write(Block_Mat_exit7_proc_U0_img_2_cols_V_out_write)
);
...
fifo_w32_d1_A img_0_rows_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit7_proc_U0_img_0_rows_V_out_din),
    .if_full_n(img_0_rows_V_c_full_n),
    .if_write(Block_Mat_exit7_proc_U0_img_0_rows_V_out_write),
...
fifo_w32_d1_A img_0_cols_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit7_proc_U0_img_0_cols_V_out_din),
    .if_full_n(img_0_cols_V_c_full_n),
    .if_write(Block_Mat_exit7_proc_U0_img_0_cols_V_out_write),
...
fifo_w32_d3_A img_1_rows_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit7_proc_U0_img_1_rows_V_out_din),
    .if_full_n(img_1_rows_V_c_full_n),
    .if_write(Block_Mat_exit7_proc_U0_img_1_rows_V_out_write),
...
fifo_w32_d3_A img_1_cols_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit7_proc_U0_img_1_cols_V_out_din),
    .if_full_n(img_1_cols_V_c_full_n),
    .if_write(Block_Mat_exit7_proc_U0_img_1_cols_V_out_write),
...
fifo_w32_d4_A img_2_rows_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit7_proc_U0_img_2_rows_V_out_din),
    .if_full_n(img_2_rows_V_c_full_n),
    .if_write(Block_Mat_exit7_proc_U0_img_2_rows_V_out_write),
...
fifo_w32_d4_A img_2_cols_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit7_proc_U0_img_2_cols_V_out_din),
    .if_full_n(img_2_cols_V_c_full_n),
    .if_write(Block_Mat_exit7_proc_U0_img_2_cols_V_out_write),
...
start_for_ThreshoeOg start_for_ThreshoeOg_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(Block_Mat_exit7_proc_U0_start_write),
...
assign Block_Mat_exit7_proc_U0_ap_continue = 1'b1;

assign Block_Mat_exit7_proc_U0_ap_start = 1'b1;

assign Block_Mat_exit7_proc_U0_start_full_n = (start_for_Threshold_U0_full_n & start_for_Mat2AXIvideo_U0_full_n);

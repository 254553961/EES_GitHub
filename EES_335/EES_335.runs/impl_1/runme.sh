...
HD_PWD='E:/EES_Board/EES_335/EES_335.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EES_335_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EES_335_wrapper.tcl -notrace

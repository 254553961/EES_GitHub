...
HD_PWD='E:/EES_Board/EES_335/EES_335.runs/EES_335_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EES_335_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EES_335_axi_gpio_0_0.tcl

...
HD_PWD='E:/EES_Board/EES_335/EES_335.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EES_335_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EES_335_wrapper.tcl

...
reg   [0:0] exitcond_i_reg_593;
wire   [0:0] brmerge_i_fu_516_p2;
wire    ap_CS_fsm_state8;
wire   [0:0] ap_phi_mux_eol_2_i_phi_fu_465_p4;
...
reg   [31:0] t_V_2_reg_368;
reg   [0:0] eol_reg_379;
reg   [23:0] axi_data_V_1_i_reg_390;
reg   [0:0] eol_i_reg_401;
reg   [31:0] rows_V_reg_554;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_559;
reg   [23:0] tmp_data_V_reg_564;
wire    AXI_video_strm_V_id_V0_status;
reg   [0:0] tmp_last_V_reg_572;
wire   [0:0] exitcond2_i_fu_491_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_496_p2;
reg   [31:0] i_V_reg_588;
wire   [0:0] exitcond_i_fu_502_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op74_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_507_p2;
reg    ap_enable_reg_pp1_iter0;
reg    ap_block_state8;
reg    ap_block_pp1_stage0_subdone;
reg   [0:0] axi_last_V_3_i_reg_438;
reg   [0:0] axi_last_V1_i_reg_337;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state3;
reg   [23:0] axi_data_V_3_i_reg_450;
reg   [23:0] axi_data_V1_i_reg_347;
reg   [31:0] t_V_reg_357;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_430_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_413;
wire   [23:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_426;
wire    ap_CS_fsm_state7;
reg   [0:0] eol_2_i_reg_462;
reg    AXI_video_strm_V_id_V0_update;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_266;
wire   [0:0] tmp_user_V_fu_482_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_fu_502_p2 == 1'd1))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        axi_data_V1_i_reg_347 <= tmp_data_V_reg_564;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        axi_data_V1_i_reg_347 <= axi_data_V_3_i_reg_450;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_reg_593 == 1'd0))) begin
        axi_data_V_1_i_reg_390 <= ap_phi_mux_p_Val2_s_phi_fu_430_p4;
    end else if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd0))) begin
        axi_data_V_1_i_reg_390 <= axi_data_V1_i_reg_347;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        axi_data_V_3_i_reg_450 <= axi_data_V_1_i_reg_390;
    end else if ((~((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_462 == 1'd0))) begin
        axi_data_V_3_i_reg_450 <= AXI_video_strm_V_data_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        axi_last_V1_i_reg_337 <= tmp_last_V_reg_572;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        axi_last_V1_i_reg_337 <= axi_last_V_3_i_reg_438;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        axi_last_V_3_i_reg_438 <= eol_reg_379;
    end else if ((~((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_462 == 1'd0))) begin
        axi_last_V_3_i_reg_438 <= AXI_video_strm_V_last_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        eol_2_i_reg_462 <= eol_i_reg_401;
    end else if ((~((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_462 == 1'd0))) begin
        eol_2_i_reg_462 <= AXI_video_strm_V_last_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_reg_593 == 1'd0))) begin
        eol_i_reg_401 <= ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4;
    end else if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd0))) begin
        eol_i_reg_401 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_reg_593 == 1'd0))) begin
        eol_reg_379 <= ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4;
    end else if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd0))) begin
        eol_reg_379 <= axi_last_V1_i_reg_337;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_fu_502_p2 == 1'd0))) begin
        t_V_2_reg_368 <= j_V_fu_507_p2;
    end else if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd0))) begin
        t_V_2_reg_368 <= 32'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((img_cols_V_out_full_n == 1'b0) | (img_rows_V_out_full_n == 1'b0) | (img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        cols_V_reg_559 <= img_cols_V_dout;
        rows_V_reg_554 <= img_rows_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        exitcond_i_reg_593 <= exitcond_i_fu_502_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i_V_reg_588 <= i_V_fu_496_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'b1 == AXI_video_strm_V_id_V0_status))) begin
        tmp_data_V_reg_564 <= AXI_video_strm_V_data_V_dout;
        tmp_last_V_reg_572 <= AXI_video_strm_V_last_V_dout;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_462 == 1'd0)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (brmerge_i_fu_516_p2 == 1'd0) & (exitcond_i_reg_593 == 1'd0) & (1'b0 == ap_block_pp1_stage0)))) begin
...
always @ (*) begin
    if (((~((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_462 == 1'd0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op74_read_state6 == 1'b1)) | ((1'b1 == ap_CS_fsm_state2) & (1'b1 == AXI_video_strm_V_id_V0_status)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (exitcond2_i_fu_491_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_149)) begin
        if ((brmerge_i_fu_516_p2 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4 = eol_reg_379;
        end else if ((brmerge_i_fu_516_p2 == 1'd0)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4 = AXI_video_strm_V_last_V_dout;
        end else begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4 = ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_413;
        end
    end else begin
        ap_phi_mux_axi_last_V_2_i_phi_fu_418_p4 = ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_413;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_149)) begin
        if ((brmerge_i_fu_516_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_430_p4 = axi_data_V_1_i_reg_390;
        end else if ((brmerge_i_fu_516_p2 == 1'd0)) begin
            ap_phi_mux_p_Val2_s_phi_fu_430_p4 = AXI_video_strm_V_data_V_dout;
        end else begin
            ap_phi_mux_p_Val2_s_phi_fu_430_p4 = ap_phi_reg_pp1_iter1_p_Val2_s_reg_426;
        end
    end else begin
        ap_phi_mux_p_Val2_s_phi_fu_430_p4 = ap_phi_reg_pp1_iter1_p_Val2_s_reg_426;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_reg_593 == 1'd0) & (1'b0 == ap_block_pp1_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (1'b1 == AXI_video_strm_V_id_V0_status) & (tmp_user_V_fu_482_p1 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_482_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (1'b1 == AXI_video_strm_V_id_V0_status))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_462 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (ap_phi_mux_eol_2_i_phi_fu_465_p4 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_id_V0_status) & (ap_predicate_op74_read_state6 == 1'b1)) | ((img_data_stream_2_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_id_V0_status) & (ap_predicate_op74_read_state6 == 1'b1)) | ((img_data_stream_2_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_id_V0_status) & (ap_predicate_op74_read_state6 == 1'b1)) | ((img_data_stream_2_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0))));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_id_V0_status) & (ap_predicate_op74_read_state6 == 1'b1)) | ((img_data_stream_2_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (exitcond_i_reg_593 == 1'd0)));
end

always @ (*) begin
    ap_block_state8 = ((1'b0 == AXI_video_strm_V_id_V0_status) & (eol_2_i_reg_462 == 1'd0));
end

always @ (*) begin
    ap_condition_149 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond_i_reg_593 == 1'd0) & (1'b0 == ap_block_pp1_stage0));
end

assign ap_enable_pp1 = (ap_idle_pp1 ^ 1'b1);

assign ap_phi_mux_eol_2_i_phi_fu_465_p4 = eol_2_i_reg_462;

assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_413 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_426 = 'bx;

always @ (*) begin
    ap_predicate_op74_read_state6 = ((brmerge_i_fu_516_p2 == 1'd0) & (exitcond_i_reg_593 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_516_p2 = (sof_1_i_fu_266 | eol_i_reg_401);

assign exitcond2_i_fu_491_p2 = ((t_V_reg_357 == rows_V_reg_554) ? 1'b1 : 1'b0);

assign exitcond_i_fu_502_p2 = ((t_V_2_reg_368 == cols_V_reg_559) ? 1'b1 : 1'b0);

assign i_V_fu_496_p2 = (t_V_reg_357 + 32'd1);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_430_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_430_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_430_p4[23:16]}};

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_507_p2 = (t_V_2_reg_368 + 32'd1);

assign start_out = real_start;

assign tmp_user_V_fu_482_p1 = AXI_video_strm_V_user_V_dout;

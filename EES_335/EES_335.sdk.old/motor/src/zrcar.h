...
/*************************WHEEL base address********************************/
#define WHEEL_CTRL_RA_BASEADDR 0x43c01000
#define WHEEL_CTRL_RF_BASEADDR 0x43c10000

#define WHEEL_CTRL_LA_BASEADDR 0x43c00000
#define WHEEL_CTRL_LF_BASEADDR 0x43c02000
...
#define WHEEL_PID_PWM_OFFSET 			(5 * 4)
...
typedef struct PID
{
	...
	int16_t  Proportion;         //比例常数 Proportional Const
	int16_t  Integral;           //积分常数 Integral Const
